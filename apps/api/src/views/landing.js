  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .card{background:#232323;border:1px solid rgba(255,255,255,.06);border-radius:10px;
      ...
      transition:border-color .2s,box-shadow .2s;max-width:400px}
    @media(max-width:680px){.grid{grid-template-columns:1fr;}.card{max-width:100%}}
  ...
  const cards = galleries.length === 0
    ...
    : galleries.map(g => {
        ...
        const thumb   = g.coverName
          ...
          : isVideo
            ? `<img src="/api/video-covers/${g.id}" class="card-img" alt="" loading="lazy" onerror="this.parentElement.innerHTML='<div class=\\'card-img-placeholder\\' style=\\'font-size:2rem\\'>&#127916;</div>'">`
            : `<div class="card-img-placeholder">&#128247;</div>`;
